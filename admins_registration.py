...
# --- REPLACED: Flask-Mail Email Sending Function ---
def send_invite_email(recipient_email, society_name, invite_token, base_url):
    ...
    # CRITICAL: Use Flask-Mail's Message object here
    msg = Message(
        subject=subject,
    ...
    try:
        mail.send(msg) # CRITICAL: This line uses the Flask-Mail extension
        return True
...
# Changed route to only accept POST, removed GET logic
...
def approve_request(request_id):
    ...
    try:
        ...
        email_sent = send_invite_email(
            request_data['email'],
            clean_society_name,  # ✅ Cleaned name here
            invite_token,
            base_url
        )
...
def open_invite():
        ...
        try:
            ...
            cursor.execute("""
                ...
                AND 
                    review_status = 'new_invitation';
            """, (
                society_name, email, mobile, psycopg2.Binary(hashed_password), 
    ...
    if request.method == 'GET':
        ...
        # ✅ FIX: Trim INVITE_ prefix before rendering
